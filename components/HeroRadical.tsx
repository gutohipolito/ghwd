        ...
        <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-black">
            ...
            >
                <Link
                    ...
                    className="group flex items-center gap-4 bg-white text-black px-10 py-5 rounded-none uppercase font-black text-xl tracking-tighter hover:bg-emerald-500 hover:text-black transition-all duration-300 transform hover:-skew-x-12 whitespace-nowrap"
                >
                    <span className="whitespace-nowrap">{t('nav.start_project')}</span>
