                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12 border-b border-white/[0.05] pb-20">
                    <div className="max-w-none md:max-w-4xl lg:max-w-5xl">
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            className="text-[7.5vw] sm:text-5xl md:text-5xl lg:text-6xl font-heading font-black text-white leading-none md:leading-[0.9] tracking-tightest mb-8 uppercase break-words"
                        >
                            {t('footer.title_1')}<br />
